...
int32_t legacy_msm_led_i2c_trigger_get_subdev_id(struct msm_flash_ctrl_t *fctrl,
	void *arg);

int32_t legacy_msm_led_i2c_trigger_config(struct msm_flash_ctrl_t *fctrl,
	void *data);

int legacy_msm_flash_led_init(struct msm_flash_ctrl_t *fctrl);
int legacy_msm_flash_led_release(struct msm_flash_ctrl_t *fctrl);
int legacy_msm_flash_led_off(struct msm_flash_ctrl_t *fctrl);
int legacy_msm_flash_led_low(struct msm_flash_ctrl_t *fctrl);
int legacy_msm_flash_led_high(struct msm_flash_ctrl_t *fctrl);
#endif
