...
static int ktd3137_brightness_table_reg4[256] = {0x01, 0x02, 0x04, 0x04, 0x07,
	...
	0x07};
static int ktd3137_brightness_table_reg5[256] = {0x00, 0x06, 0x0C, 0x11, 0x15,
...
static struct device *ktd3137_device_create(void *drvdata, const char *fmt)
{
	struct device *dev;
