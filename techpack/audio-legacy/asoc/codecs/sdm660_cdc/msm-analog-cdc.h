...
struct sdm660_cdc_priv {
	...
	int (*codec_hph_pa_gpio_get_cb)(struct snd_soc_codec *codec);
	int (*codec_hph_pa_gpio_set_cb)(struct snd_soc_codec *codec, int enable);
	int (*codec_spk_pa_gpio_get_cb)(struct snd_soc_codec *codec);
	int (*codec_spk_pa_gpio_set_cb)(struct snd_soc_codec *codec, int enable);
