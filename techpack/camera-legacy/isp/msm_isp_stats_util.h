...
void legacy_msm_isp_stats_disable(struct vfe_device *vfe_dev);
int legacy_msm_isp_stats_reset(struct vfe_device *vfe_dev);
int legacy_msm_isp_stats_restart(struct vfe_device *vfe_dev);
